...
def pdf_with_error_correct():
    return (
        Table.read(
            "tests/data/ngc2527_small_pdf_with_error.txt", format="ascii"
        )
        .to_pandas()["pdf"]
        .to_numpy()
        .ravel()
...
class TestHKDE:
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                np.array(
                    [[1, -0.05, -0.05], [-0.05, 1, -0.05], [-0.05, -0.05, 1]]
                ),
                None,
                np.array(
                    [[1, -0.05, -0.05], [-0.05, 1, -0.05], [-0.05, -0.05, 1]]
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                np.array(
                    [[1, -0.05, -0.05], [-0.05, 1, 25], [-0.05, -0.05, 1]]
                ),
                None,
                np.array(
                    [[1, -0.05, -0.05], [-0.05, 1, -0.05], [-0.05, -0.05, 1]]
            ...
            (
                np.array(
                    [[1, -0.05, -0.05], [-0.05, 2, 25], [-0.05, -0.05, 1]]
                ),
                ValueError,
                None,
            ),
